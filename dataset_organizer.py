...
def convert_video_to_img():
    ...
    for file_name in os.listdir(dir_path):
        ...
        try:
            if os.path.exists(dst_directory_path):
                ...
                if not os.path.exists(os.path.join(dst_directory_path, 'image_00001.jpg')):
                    ...
                    subprocess.call(
                        'del -f {}'.format(dst_directory_path), shell=True)
        ...
        cmd = 'ffmpeg -i {} -vf thumbnail=10,setpts=N/TB -r 1 -vframes 100 {}/image_%05d.jpg'.format(
        ...
        if frame_len != 10:
            with open('D:/Thesis/src/Deepfake-Detection/src/RCN/failure.txt', 'a+') as f:
